                            ...
                            <div className="relative z-10">
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {scoresList.map((score: any, idx: number) => {
                                        // Tradução Apenas do Título do Traço
                                        ...
                                        const displayTraitName = traitNameMap[score.traitName?.toLowerCase()] || score.traitName;

                                        return (
                                            <div key={idx} className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors">
                                                <div className="flex justify-between items-start mb-4">
                                                    <h4 className="font-bold text-lg text-gray-200">{displayTraitName}</h4>
