...
export default function SettingsPage() {
    ...
    const { data: settings, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch('http://localhost:3000/api/v1/site-settings/admin', {
    ...
    const saveMutation = useMutation({
        mutationFn: async (data: any) => {
            const res = await fetch('http://localhost:3000/api/v1/site-settings', {
                method: 'PUT',
                headers: {
    ...
    const resetMutation = useMutation({
        mutationFn: async () => {
            const res = await fetch('http://localhost:3000/api/v1/site-settings/reset', {
                method: 'POST',
                headers: { Authorization: `Bearer ${token}` }
            });
            return res.json();
