...
interface Client {
    ...
    googleId?: string | null; // ← Google OAuth
    linkedinId?: string | null; // ← LinkedIn OAuth
}
                        ...
                        <div key={client.id} className="relative bg-white p-4 md:p-0 rounded-2xl shadow-sm md:shadow-none md:rounded-none md:grid md:grid-cols-12 md:gap-4 md:px-6 md:py-5 border-b border-gray-100 hover:bg-slate-50 transition-colors items-center group">
                            ...
                            <div className="col-span-5 flex items-start gap-4">
                                ...
                                <div className="space-y-1 overflow-hidden">
                                    ...
                                    <div className="text-sm text-gray-500 flex items-center gap-2 break-all">
                                        <Mail size={12} className="shrink-0" /> {client.email}
                                        {client.googleId && (
                                            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-50 text-blue-700 text-[10px] font-bold rounded-full border border-blue-200 shrink-0" title="Autenticado via Google">
                                        ...
                                        {client.linkedinId && (
                                            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-50 text-blue-700 text-[10px] font-bold rounded-full border border-blue-200 shrink-0" title="Autenticado via LinkedIn">
