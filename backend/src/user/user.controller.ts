    ...
    async listClients(@Request() req) {
        ...
        if (req.user.role === 'SUPER_ADMIN') {
            return this.prisma.user.findMany({
                ...
                select: { id: true, name: true, email: true, role: true, credits: true, createdAt: true, status: true, companyName: true, userType: true, plan: true, viewedByAdmin: true, phone: true, cpf: true, cnpj: true, mustChangePassword: true, googleId: true, linkedinId: true }
            });
        }
