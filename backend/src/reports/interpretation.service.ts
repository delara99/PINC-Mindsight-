        ...
        for (const trait of config.traits) {
            ...
            if (!traitResponses || traitResponses.length === 0) {
                ...
                const equivalents: Record<string, string[]> = {
                    ...
                    'NEUROTICISM': ['NEUROTICISMO', 'ESTABILIDADE EMOCIONAL', 'ESTABILIDADE', 'RESILIENCIA', 'EMOCIONAL', 'NEURO', 'FATOR_N', 'FACTOR_N', 'FATOR_IV', 'FACTOR_IV'],
                    'NEUROTICISMO': ['NEUROTICISM', 'ESTABILIDADE EMOCIONAL', 'ESTABILIDADE', 'RESILIENCIA', 'EMOCIONAL'],
                    'ESTABILIDADE EMOCIONAL': ['NEUROTICISM', 'NEUROTICISMO', 'ESTABILIDADE'],
