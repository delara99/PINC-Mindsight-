...
function resetAllPasswords() {
    return __awaiter(this, void 0, void 0, function () {
        var newPassword, hashedPassword, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    result = _a.sent();
                    console.log("\u2705 ".concat(result.count, " senhas atualizadas com sucesso!"));
                    console.log('');
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('❌ Erro ao atualizar senhas:', error_1);
                    return [3 /*break*/, 6];
