...
const BEHAVIOR_TEXTS = [
    // === EXTROVERSÃO (E) ===
    {
        ...
        group: 'DIMENSION',
        description: 'Extroversão - Baixa (Comportamentos Apresentados)',
    ...
    },
    {
        ...
        group: 'DIMENSION',
        description: 'Extroversão - Média (Comportamentos Apresentados)',
        content: 'Você é uma pessoa equilibrada em termos de sociabilidade. Você gosta de interagir com os outros, mas também valoriza seu tempo sozinho(a). Você pode se sentir energizado(a) em certas situações sociais, mas também pode precisar de momentos de isolamento. De modo geral, você pode participar de eventos sociais e conversas, mas também aprecia momentos de tranquilidade e introspecção. Situações extremas tendem a sobrecarregá-lo.'
    },
    {
        key: 'EXTRAVERSION_HIGH',
        group: 'DIMENSION',
        description: 'Extroversão - Alta (Comportamentos Apresentados)',
    ...
    // === AMABILIDADE (A) ===
    {
        ...
        group: 'DIMENSION',
        description: 'Amabilidade - Baixa (Comportamentos Apresentados)',
    ...
    },
    {
        ...
        group: 'DIMENSION',
        description: 'Amabilidade - Média (Comportamentos Apresentados)',
    ...
    },
    {
        ...
        group: 'DIMENSION',
        description: 'Amabilidade - Alta (Comportamentos Apresentados)',
    ...
    // === ESTRUTURA / CONSCIENCIOSIDADE (C) ===
    {
        ...
        group: 'DIMENSION',
        description: 'Estrutura - Baixa (Comportamentos Apresentados)',
    ...
    },
    {
        ...
        group: 'DIMENSION',
        description: 'Estrutura - Média (Comportamentos Apresentados)',
    ...
    },
    {
        ...
        group: 'DIMENSION',
        description: 'Estrutura - Alta (Comportamentos Apresentados)',
    ...
    // === ABERTURA (O) ===
    {
        key: 'OPENNESS_LOW',
        group: 'DIMENSION',
        description: 'Abertura - Baixa (Comportamentos Apresentados)',
    ...
    },
    {
        key: 'OPENNESS_AVG',
        group: 'DIMENSION',
        description: 'Abertura - Média (Comportamentos Apresentados)',
    ...
    },
    {
        key: 'OPENNESS_HIGH',
        group: 'DIMENSION',
        description: 'Abertura - Alta (Comportamentos Apresentados)',
    ...
    {
        key: 'NEUROTICISM_HIGH',
        group: 'DIMENSION',
        description: 'Estabilidade - Baixa (Comportamentos Apresentados)',
    ...
    },
    {
        key: 'NEUROTICISM_AVG',
        group: 'DIMENSION',
        description: 'Estabilidade - Média (Comportamentos Apresentados)',
    ...
    },
    {
        key: 'NEUROTICISM_LOW',
        group: 'DIMENSION',
        description: 'Estabilidade - Alta (Comportamentos Apresentados)',
